...
Current supported modes of transport are Driving using car where as Walking (Beta) and Cycling (Beta) are provided as experimental using the following below parameters
